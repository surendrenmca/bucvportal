...
$ret="select c.*,p.* from colleges c, programme_details p where c.user_id=p.college_id and p.college_id=? order by p.college_id";
...
<td><a class='btn btn-info btn-lg'  href='student-details-admin.php?course_id=<?php echo $row->id;?>'> 
  <i class='fa fa-eye' aria-hidden='true'></i> <?php  echo $row->id; ?></a></td>
